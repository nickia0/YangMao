...
refreshtokenVal 👉XP_REFRESHTOKEN_3_4
...
if ($.isNode() && process.env.XP_REFRESHTOKEN_3_4) {
    ...
    if (
        process.env.XP_REFRESHTOKEN_3_4 &&
        process.env.XP_REFRESHTOKEN_3_4.indexOf(COOKIES_SPLIT) > -1
    ) {
        middlerefreshTOKEN = process.env.XP_REFRESHTOKEN_3_4.split(COOKIES_SPLIT);
    } else {
        middlerefreshTOKEN = process.env.XP_REFRESHTOKEN_3_4.split();
    }
}
