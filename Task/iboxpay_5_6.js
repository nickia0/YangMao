...
refreshtokenVal 👉XP_REFRESHTOKEN_5_6
...
if ($.isNode() && process.env.XP_REFRESHTOKEN_5_6) {
    ...
    if (
        process.env.XP_REFRESHTOKEN_5_6 &&
        process.env.XP_REFRESHTOKEN_5_6.indexOf(COOKIES_SPLIT) > -1
    ) {
        middlerefreshTOKEN = process.env.XP_REFRESHTOKEN_5_6.split(COOKIES_SPLIT);
    } else {
        middlerefreshTOKEN = process.env.XP_REFRESHTOKEN_5_6.split();
    }
}
